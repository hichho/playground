        ...
        if ("undefined" == typeof XRegExp) {
          ...
          void 0 !== this.rootPath
            ? ((c =
                ...
                "/third-party/SyntaxHighlighter/shCore.ueditor"),
              (d =
                a.removeLastbs(this.rootPath) +
    ...
    UE.parse.register("charts", function(a) {
      ...
      function f() {
        window.jQuery
          ...
          : a.loadFile(
              document,
              {
                src: m + "/third-party/jquery-1.10.2.min.ueditor",
                tag: "script",
                type: "text/javascript",
                defer: "defer"
              },
      ...
      function g() {
        window.Highcharts
          ...
          : a.loadFile(
              document,
              {
                src: m + "/third-party/highcharts/highcharts.ueditor",
                tag: "script",
                type: "text/javascript",
                defer: "defer"
              },
      ...
      function h() {
        a.loadFile(
          document,
          {
            src: m + "/dialogs/charts/chart.config.ueditor",
            tag: "script",
            type: "text/javascript",
            defer: "defer"
          },
    ...
    UE.parse.register("vedio", function(a) {
      ...
      if (
        ...
        var d = a.removeLastbs(this.rootPath),
          e = d + "/third-party/video-ueditor/video.ueditor",
          f = d + "/third-party/video-ueditor/video-ueditor.min.css",
          g = d + "/third-party/video-ueditor/video-ueditor.swf";
        window.videojs
          ? videojs.autoSetup()
          : (a.loadFile(document, {
              id: "video_css",
